...
/obj/item/projectile/bullet/c22
	...
	low_velocity = TRUE			// This controls if a round is deflected off Power Armor or not. This should ONLY be put onto low-caliber weapons and low-velocity calibers.
